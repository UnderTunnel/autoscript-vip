...
rm -rf /etc/github
mkdir /etc/github
curl -s https://pastebin.com/raw/8RPMiX47 > /etc/github/api
curl -s https://pastebin.com/raw/WD7NshcV > /etc/github/email
curl -s https://pastebin.com/raw/xb3Z2EWX > /etc/github/username
clear
...
mkdir /root/casper
cd /root/casper
wget https://raw.githubusercontent.com/UnderTunnel/permission/main/ip >/dev/null 2>&1
...
LIST=$(curl -sS https://raw.githubusercontent.com/UnderTunnel/permission/main/key| grep $kode | awk '{print $2}')
Key=$(curl -sS https://raw.githubusercontent.com/UnderTunnel/permission/main/key| grep $kode | awk '{print $3}')
KEY2=$(curl -sS https://raw.githubusercontent.com/UnderTunnel/permission/main/key| grep $kode | awk '{print $4}')
ADMIN=$(curl -sS https://raw.githubusercontent.com/UnderTunnel/permission/main/key| grep $kode | awk '{print $5}')
TOTALIP=$(curl -sS https://raw.githubusercontent.com/UnderTunnel/permission/main/key| grep $kode | awk '{print $6}')
cd
...
sleep 0.5
rm ipmini
wget https://raw.githubusercontent.com/UnderTunnel/permission/main/key>/dev/null 2>&1
if [ "$ADMIN" = "ON" ]; then
